...
namespace UnityEditor.Experimental.Rendering.HDPipeline
{
    ...
    static class RenderPipelineSettingsUI
    {
        ...
        static readonly GUIContent k_DefaultRaytracingLayer = EditorGUIUtility.TrTextContent("Default Raytracing Sub-scene");
        ...
        static void Drawer_SectionPrimarySettings(SerializedRenderPipelineSettings d, Editor o)
        {
            ...
            if(UnityEngine.SystemInfo.supportsRayTracing)
            {
                ...
                {
                    ++EditorGUI.indentLevel;
                    EditorGUILayout.PropertyField(d.defaultLayerMask, k_DefaultRaytracingLayer);
                    --EditorGUI.indentLevel;
                }
            }
            else
